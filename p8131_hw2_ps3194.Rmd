...
```
The estimate for $\hat{\beta}$ is `r beta_1_mph` b and the 95% CI is (`r beta_estimate_ci_lower`, `r beta_estimate_ci_higher`) Per $1 increase in scholarship amount,there is an 0.03095043 unit increase in log odds ratio of enrollment rate  
